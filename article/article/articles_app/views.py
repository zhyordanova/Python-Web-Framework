...
class ArticleCreateView(views.CreateView):
    model = Article
    template_name = 'articles_app/create-article.html'
...
class SourceCreateView(views.CreateView):
    model = Source
    template_name = 'articles_app/create-source.html'
    # success_url = reverse_lazy('index')
    fields = '__all__'
...
class ArticlesListView(views.ListView):
    model = Article
    template_name = 'articles_app/list-articles.html'
    # context_object_name = 'articles'


class SourceDetailsView(SingleObjectMixin, views.ListView):
    model = Source
    template_name = 'articles_app/details-source.html'
    object = None
    paginate_by = 3
...
class SourcesListView(views.ListView):
    model = Source
    template_name = 'articles_app/list-sources.html'
